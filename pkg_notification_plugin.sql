CREATE OR REPLACE PACKAGE ace_toast_notification AS
-- =============================================================================
...
CREATE OR REPLACE PACKAGE BODY ace_toast_notification AS
  ...
  FUNCTION render (
    ...
    l_toast_type    VARCHAR2(20)   := p_dynamic_action.attribute_01;
    l_message       VARCHAR2(4000) := p_dynamic_action.attribute_02;
    l_position      VARCHAR2(20)   := p_dynamic_action.attribute_03;
  ...
  BEGIN
    ...
    -- Inject CSS and global JS function once per page
      ...
      p_code => q'[
        if (!window.aceToastInitialized) {
          ...
          style.innerHTML = [
            ...
            "  font-family: inherit; color: #fff; min-width: 240px;",
            "  max-width: 360px; animation: aceToastIn 0.35s ease forwards;",
          ...
          window.aceShowToast = function(type, message, position, duration) {
            ...
            iconSpan.className = "ace-toast-icon";
            iconSpan.textContent = icons[type] || "\u2139";

            var bodyDiv = document.createElement("div");
            bodyDiv.className = "ace-toast-body";

            var titleDiv = document.createElement("div");
            titleDiv.className = "ace-toast-title";
            titleDiv.textContent = type;

            var msgDiv = document.createElement("div");
            msgDiv.className = "ace-toast-message";
            ...
            closeBtn.className = "ace-toast-close";
